...
type UserModel struct {
	...
	Username  string    `gorm:"column:username;type:varchar(255);index:,class:FULLTEXT" example:"admin"`
	Password  string    `gorm:"column:password;type:char(60)" example:"123456"`
